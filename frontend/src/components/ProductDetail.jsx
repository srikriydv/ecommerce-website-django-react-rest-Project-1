import { createSearchParams, json, Link } from "react-router-dom";
...
function ProductDetail() {
  ...
  const cartRemoveButtonHandler = () => {
    ...
    let cartJson = JSON.parse(prevCart);
    document.getElementById("hello").innerHTML = cartJson;
  ...
  function checkProductInCart(product_id) {
    ...
    document.getElementById('hello2').innerHTML = cartJson;
